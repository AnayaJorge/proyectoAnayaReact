                ...
                <div className="row">
                    ...
                    <div className="col md-6 d-flex align-items-end">
                        <div>
                            ...
                            <p>
                                <a href="/" target={"_blank"} rel="noreferrer"><img src={"images/google_play.png"} alt={"Android"} width={135} /></a>
                                <a href="/" target={"_blank"} rel="noreferrer"><img src={"images/app__store.png"} alt={"Apple"} width={135} /></a>
                            </p>
